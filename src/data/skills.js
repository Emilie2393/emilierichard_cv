...
export const portfolio = [
  {
    ...
    details:
      "Booki est une plateforme de réservation de logements entre particuliers. Ce projet avait pour but d'intégrer une maquette donnée en HTML et CSS. Les maquettes fournies étaient en format desktop et mobile ",
  ...
  },
  {
    ...
    description:
      "Projet d'intégration web",
    details:
      "Oh My Food est une plateforme de réservation de menus de chef en ligne. Ce projet avait pour but d'intégrer une maquette donnée en HTML, CSS et d'intégrer SASS. Un code couleur a été appliqué ainsi qu'un format desktop, tablette et mobile. De plus, l'intégration de plusieurs animations à été faite grace aux keyframes notamment",
  ...
  },
  {
    ...
    details: "Kanap est un site e-commerce dynamique de vente de canapés. Il fallait ici intégrer les élements de l'API sur les pages HTML à l'aide de Javascript. Pour cela, j'ai créé 4 fichiers Javascript qui fournissait le DOM des informations nécessaires. L'API renvoyait les informations de chaque canapé. Le challenge ici était d'implémenter des fonctions asynchrones qui fonctionnaient indépendamment les unes des autres. Le local storage est utilisé pour sauvegarder les informations du panier de l'utilisateur.Enfin, des RegEx sont utilisées pour sécuriser le formulaire du panier. ",
  ...
  },
  {
    ...
    details: "Le projet de Hot Takes est la création complète d'une API. Cette plateforme sers à publier sa sauce préférée et d'aimer ou pas les publications. Il faut pour cela créer un compte utilisateur à l'aide d'une adresse mail et un mot de passe. Le mot de passe est haché et la connextion génère un token vérifié à chaque chargement de page. Cette application fonctionne à la date de la base de donnée MongoDB reliée au backend. Les utilisateurs et les produits créés sont enregistrés sur cette base de données. ",
  ...
  },
  {
    ...
    details: "Kasa est un site de location d'appartement entre particuliers. Le projet ici était de transformer l'application avec React. Le site est transcris à travers des composants sur le fichier App. React Router organise les routes de l'application. Une page d'erreur est présentée en cas de mauvaise URL.",
